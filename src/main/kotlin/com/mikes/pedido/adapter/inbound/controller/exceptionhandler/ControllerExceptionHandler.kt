package com.mikes.pedido.adapter.inbound.controller.exceptionhandler
...
class ControllerExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    fun invalidValueExceptionHandler(
    ...
    fun alreadyExistsExceptionHandler(
    ...
    fun invalidDomainStateExceptionHandler(
        e: InvalidDomainStateException,
        request: WebRequest,
    ): ResponseEntity<Error> {
